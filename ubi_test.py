...
TOKEN = "VnntUFc4XvIJMfLNVCSdFCBxVSuYdr" # Put your TOKEN here
DEVICE_LABEL = "comunicaciones" # Put your device label here 
VARIABLE_LABEL_1 = "temperatura1" # Put your first variable label here
